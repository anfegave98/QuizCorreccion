...
public class Punto4 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
         ...
         try {
            ...
            int id_unidad = Integer.parseInt(request.getParameter("idunidad"));
             
            ArrayList<Tabla> lista = (ArrayList<Tabla>) obj.getAllTablesId(id_unidad);
            
            request.setAttribute("listaPunto4", lista);
            
           request.getRequestDispatcher("Puntos4.jsp").forward(request, response);

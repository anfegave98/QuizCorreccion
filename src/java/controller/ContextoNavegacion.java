 ...
 * @author User
 */
public class ContextoNavegacion extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
         ...
         try {
            ...
            ArrayList<ContextoNavegacionn> lista = (ArrayList<ContextoNavegacionn>) obj.getAllContextos();
            
            request.setAttribute("listaContextos", lista);
            
           request.getRequestDispatcher("ContextosNavegacion.jsp").forward(request, response);

        } catch (SQLException ex) {
            
            Logger.getLogger(ContextoNavegacion.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
           ...
           int id_modelo = Integer.parseInt(request.getParameter("id_modelo"));  
            ...
            ContextoNavegacionn mod = new ContextoNavegacionn(link,id_modelo);
